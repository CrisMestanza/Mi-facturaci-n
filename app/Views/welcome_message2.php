...
function generarXML($id, $nombreCliente) {
...
$idCliente = '12345678'; // Reemplaza con tu valor
$nombreCliente = 'CLIENTE DE PRUEBA'; // Reemplaza con tu valor

// Genera el XML utilizando las variables
$xmlGenerado = generarXML($idCliente, $nombreCliente);

file_put_contents('output.xml', $xmlGenerado);
